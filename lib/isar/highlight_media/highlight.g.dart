...
const HighlightSchema = CollectionSchema(
  name: r'highlight',
  id: -8091215687505619377,
  properties: {
    r'Highlightselectvalue': PropertySchema(
      id: 0,
      name: r'Highlightselectvalue',
...
int _highlightEstimateSize(
  ...
  bytesCount += 3 + object.Highlightselectvalue.length * 3;
  return bytesCount;
}
...
void _highlightSerialize(
  ...
  writer.writeString(offsets[0], object.Highlightselectvalue);
}
...
Highlight _highlightDeserialize(
  ...
  final object = Highlight(
    Highlightselectvalue: reader.readString(offsets[0]),
    id: id,
  );
  return object;
}
...
extension HighlightQueryFilter
  ...
  QueryBuilder<Highlight, Highlight, QAfterFilterCondition>
      highlightselectvalueEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'Highlightselectvalue',
        value: value,
  ...
  QueryBuilder<Highlight, Highlight, QAfterFilterCondition>
      highlightselectvalueGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Highlight, Highlight, QAfterFilterCondition>
      highlightselectvalueStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Highlight, Highlight, QAfterFilterCondition>
      highlightselectvalueContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Highlight, Highlight, QAfterFilterCondition>
      highlightselectvalueMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Highlight, Highlight, QAfterFilterCondition>
      highlightselectvalueIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'Highlightselectvalue',
        value: '',
...
extension HighlightQuerySortBy on QueryBuilder<Highlight, Highlight, QSortBy> {
  QueryBuilder<Highlight, Highlight, QAfterSortBy>
      sortByHighlightselectvalue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'Highlightselectvalue', Sort.asc);
    });
  }

  QueryBuilder<Highlight, Highlight, QAfterSortBy>
      sortByHighlightselectvalueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'Highlightselectvalue', Sort.desc);
    });
  }
}
...
extension HighlightQuerySortThenBy
  ...
  QueryBuilder<Highlight, Highlight, QAfterSortBy>
      thenByHighlightselectvalueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'Highlightselectvalue', Sort.desc);
    });
  }
...
extension HighlightQueryWhereDistinct
  ...
  QueryBuilder<Highlight, Highlight, QDistinct> distinctByHighlightselectvalue(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'Highlightselectvalue',
          caseSensitive: caseSensitive);
    });
  }
}
...
extension HighlightQueryProperty
  ...
  QueryBuilder<Highlight, String, QQueryOperations>
      HighlightselectvalueProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'Highlightselectvalue');
    });
  }
}
