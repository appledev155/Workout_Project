...
const ActivitySchema = CollectionSchema(
  name: r'activity',
  id: -7919504185674335194,
  properties: {
    r'Activityselectvalue': PropertySchema(
      id: 0,
      name: r'Activityselectvalue',
...
int _activityEstimateSize(
  ...
  bytesCount += 3 + object.Activityselectvalue.length * 3;
  return bytesCount;
}
...
void _activitySerialize(
  ...
  writer.writeString(offsets[0], object.Activityselectvalue);
}
...
Activity _activityDeserialize(
  ...
  final object = Activity(
    Activityselectvalue: reader.readString(offsets[0]),
    id: id,
  );
  return object;
}
...
extension ActivityQueryFilter
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition>
      activityselectvalueEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'Activityselectvalue',
        value: value,
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition>
      activityselectvalueGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition>
      activityselectvalueContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition>
      activityselectvalueMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Activity, Activity, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension ActivityQuerySortBy on QueryBuilder<Activity, Activity, QSortBy> {
  QueryBuilder<Activity, Activity, QAfterSortBy> sortByActivityselectvalue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'Activityselectvalue', Sort.asc);
    });
  }

  QueryBuilder<Activity, Activity, QAfterSortBy>
      sortByActivityselectvalueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'Activityselectvalue', Sort.desc);
    });
  }
}
...
extension ActivityQuerySortThenBy
  ...
  QueryBuilder<Activity, Activity, QAfterSortBy> thenByActivityselectvalue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'Activityselectvalue', Sort.asc);
    });
  }
...
extension ActivityQueryWhereDistinct
  ...
  QueryBuilder<Activity, Activity, QDistinct> distinctByActivityselectvalue(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'Activityselectvalue',
          caseSensitive: caseSensitive);
    });
  }
}
...
extension ActivityQueryProperty
  ...
  QueryBuilder<Activity, String, QQueryOperations>
      ActivityselectvalueProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'Activityselectvalue');
    });
  }
}
